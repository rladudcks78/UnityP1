...
public class Bullet : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Distance(a, b) : a와 b사이의 거리 반환
        // 피타고라스 정리 응용 => 두 지점간 차이의 제곱근 (다른 연산에 비해서 무거움: 루트 연산을 하기 때문에 정교한 방법엔 좋음)
        ...
        // mgnitude (조금 빠름) 속성도 마찬가지로 제곱근 계산을 한다
        // sqrMagnitude (가장 빠름) 속성은 제곱근 계산을 하지 않기 때문에 성능에 유리하다
        // *최적화 관련 함수이기 때문에 포트폴리오에 쓰기 적당하다*
        // 2-3. 제곱 거리 비교 (성능 향상)
